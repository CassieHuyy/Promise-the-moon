    ...
    public partial class register : Form
    {
      ...
      "提示", MessageBoxButtons.OKCancel, MessageBoxIcon.None);
        ...
        private void txbidcard_MouseLeave(object sender, EventArgs e)
        {
            ...
            {
                erID.SetError(txbidcard, "身份证号码输入有误！");
                //erID.Icon = new System.Drawing.Icon(@"D:\DeskTop\门诊数据库0\MedicalSystem\错误.ico");
            }
        }
        ...
        private void txblblRegisterTime_TextChanged(object sender, EventArgs e)
        {
        ...
        private void ptb_Photo_Click(object sender, EventArgs e)
        {
